...
HD_PWD='C:/Users/Alessandra/Desktop/git/rec_teste_mohammedRashad/FPGA-Speech-Recognition-master/FPGA-Speech-Recognition-master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Voice_recognition.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Voice_recognition.tcl
